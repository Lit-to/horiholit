#> holit:game/count/26_chorus_flower
...
execute if data storage holit: {stats:{id:"minecraft:chorus_flower"}} run item modify entity @s enderchest.26 holit:count
item modify entity @s enderchest.26 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.26 loot holit:ender/chorus_flower
