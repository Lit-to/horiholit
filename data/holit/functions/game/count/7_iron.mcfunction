...
execute if data storage holit: {stats:{id:"minecraft:iron_ore"}} run item modify entity @s enderchest.7 holit:count
item modify entity @s enderchest.7 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.7 loot holit:ender/iron
