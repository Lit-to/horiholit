...
execute if data storage holit: {stats:{id:"minecraft:coal_ore"}} run item modify entity @s enderchest.5 holit:count
item modify entity @s enderchest.5 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.5 loot holit:ender/coal
