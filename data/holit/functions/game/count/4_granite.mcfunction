...
execute if data storage holit: {stats:{id:"minecraft:granite"}} run item modify entity @s enderchest.4 holit:count
item modify entity @s enderchest.4 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.4 loot holit:ender/granite
