#> holit:game/count/14_lapis_lazuli
...
execute if data storage holit: {stats:{id:"minecraft:lapis_ore"}} run item modify entity @s enderchest.14 holit:count
item modify entity @s enderchest.14 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.14 loot holit:ender/lapis
