...
execute if data storage holit: {stats:{id:"minecraft:copper_ore"}} run item modify entity @s enderchest.9 holit:count
item modify entity @s enderchest.9 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.9 loot holit:ender/copper
