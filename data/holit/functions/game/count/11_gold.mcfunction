...
execute if data storage holit: {stats:{id:"minecraft:gold_ore"}} run item modify entity @s enderchest.11 holit:count
item modify entity @s enderchest.11 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.11 loot holit:ender/gold
