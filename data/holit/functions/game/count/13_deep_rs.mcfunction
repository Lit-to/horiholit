...
execute if data storage holit: {stats:{id:"minecraft:deepslate_redstone_ore"}} run item modify entity @s enderchest.13 holit:count
item modify entity @s enderchest.13 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.13 loot holit:ender/deep_rs
