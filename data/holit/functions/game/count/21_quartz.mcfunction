...
execute if data storage holit: {stats:{id:"minecraft:nether_quartz_ore"}} run item modify entity @s enderchest.21 holit:count
item modify entity @s enderchest.21 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.21 loot holit:ender/quartz
