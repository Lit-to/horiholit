...
execute if data storage holit: {stats:{id:"minecraft:diamond_ore"}} run item modify entity @s enderchest.16 holit:count
item modify entity @s enderchest.16 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.16 loot holit:ender/diamond
