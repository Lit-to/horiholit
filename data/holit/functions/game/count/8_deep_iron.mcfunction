...
execute if data storage holit: {stats:{id:"minecraft:deepslate_iron_ore"}} run item modify entity @s enderchest.8 holit:count
item modify entity @s enderchest.8 holit:input
execute if data storage holit: {stats:{id:"minecraft:light_gray_stained_glass_pane"}} run loot replace entity @s enderchest.8 loot holit:ender/deep_iron
