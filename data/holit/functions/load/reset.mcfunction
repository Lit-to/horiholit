...
scoreboard players set point min_diamond_ore 50
#兄弟たち
...
scoreboard players set point min_deep_emerald_ore 101
scoreboard players set point min_deep_diamond_ore 51
# ネザーそのほか
